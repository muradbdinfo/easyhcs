...
class SystemSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->log('✅ SystemSeeder completed.');
    }

    // ── Helper: safe log (null-safe for Artisan::call context) ───────────────
    ...
    private function seedPlans(): void
    {
        ...
        $this->log('  Plans seeded (' . count($plans) . ')');
    }
    ...
    private function seedPaymentGateways(): void
    {
        ...
        foreach ($gateways as $gateway) {
            DB::table('payment_gateways')->updateOrInsert(['slug' => $gateway['slug']], $gateway);
        }

        $this->log('  Payment gateways seeded (' . count($gateways) . ')');
    }
